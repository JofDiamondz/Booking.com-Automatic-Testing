...
public class GuestRoomTest extends BaseTest {
    ...
    // driver and wait are inherited from BaseTest — do NOT redeclare them
    ...
    // Lazy getter — returns actions, initializing it if setUp hasn't run yet
    ...
    @BeforeClass
    public void setUp() {
        super.setUp();  // launches browser, sets driver + wait
        // Initialize helpers AFTER super.setUp() so driver is guaranteed non-null
        js      = (JavascriptExecutor) driver;
        actions = new Actions(driver);
        // Set implicitWait to 0 so explicit waits work correctly alongside waits
